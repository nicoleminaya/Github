...
parser.add_argument('--gnn',
                    ...
                    choices = ['cheb1','cheb2'],
                    type    = str,
                    help    = "ChebNeb version")
args    = parser.parse_args()

if args.gnn == 'cheb1':
    from model.anytown import ChebNet  # Importing Anytown model directly
else:
    from model.anytown_v2 import ChebNet  # Importing Anytown model directly  ----> por ratio tunning
...
def run_evaluation():
    ...
    for run_id in range(1, RUNS + 1):
        ...
        #run_stamp = f"{WDS_NAME}-random-{BUDGET}-binary-def-{run_id}"
